...
class Cron:
    def crawling_rec(self):
        ...
        for apartment in search_list:
            ...
            order_by_lowest_price = browser.find_element(
                By.CSS_SELECTOR,
                "#complexOverviewList > div.list_contents > div.list_fixed > div.sorting > a:nth-child(3)",
            )
            ...
            lowest_price = browser.find_element(
                By.CSS_SELECTOR,
                "#ct > div.map_wrap > div.detail_panel > div > div.detail_contents_inner > div.detail_fixed > div.main_info_area > div.info_article_price",
            ).text
    ...
    def crawling_rec_tuple(apart_list):
        ...
        for apart in apart_list:
            ...
            lowest_price_text = browser.find_element(
                By.CSS_SELECTOR,
                "#articleListArea > div:nth-child(1) > div > a.item_link > div.item_title",
            )
            lowest_price_text.click()
            time.sleep(2)
